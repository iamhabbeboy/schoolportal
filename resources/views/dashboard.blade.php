                ...
                <div class="card">
                        <br>
                            <div style="font-size: 12px;border-bottom: 2px solid #37BF91;color: #37BF91;margin-bottom: 10px;">
                                <b>Welcome back, {{ array_get($students, 'student_info.name') }}</b>
                            </div>
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-8" style="font-size:12px">
                                        ...
                                        <p>
                                            ...
                                            <p>
                                                <a href="{{ route('home') }}">&raquo; Personal Information </a>
                                            </p>
                                            <p>
                                                <a href="{{ route('result') }}">&raquo; Result Information</a>
                                            </p>
                                            <p>
                                                <a href="{{ route('admission')}}">&raquo; Admission Status</a>
                                            </p>
                                            <p>
                                                <a href="{{ route('history') }}">&raquo; Payment History</a>
                                            </p>
                                            <p>
                                                <a href="{{ route('course-register') }}">&raquo; Course Registration</a>
                                            </p>
                                            <p>
                                                <a href="{{ route('school-fee') }}">&raquo; School Fee Payment </a>
                                            </p>
                                        @else
                                            <p>
                                    ...
                                    <div class="col-md-3">
                                        <div class="profile-holder" style="height: 199px;overflow:hidden">
